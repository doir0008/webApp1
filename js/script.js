...
var movieNav = document.getElementById("moviebtn");
var castNav = document.getElementById("castbtn");
var reviewsNav = document.getElementById("reviewsbtn");

var homeBtn = new Hammer(movieNav);
var castBtn = new Hammer(castNav);
var reviewBtn = new Hammer(reviewsNav);
/*
homeBtn.on('tap', function(ev){
    console.log("Tap on home button");
});
castBtn.on('tap', function(ev){
    console.log("Tap on cast button");
});
reviewBtn.on('tap', function(ev){
    console.log("Tap on review button");
});
*/